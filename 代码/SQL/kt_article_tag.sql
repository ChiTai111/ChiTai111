...
/*Table structure for table kt_article_tag` */

DROP TABLE IF EXISTS `kt_article_tag`;

CREATE TABLE `kt_article_tag` (
...
/*Data for the table `kt_article_tag` */

insert  into `kt_article_tag`(`article_id`,`tag_id`) values (1,4),(2,1),(2,4),(3,4),(3,5);
