...
//对原始文件名进行判断
        if(!originalFilename.endsWith(".png") && !originalFilename.endsWith(".jpg")){
            throw new SystemException(AppHttpCodeEnum.EMAIL_EXIST.FILE_TYPE_ERROR);
        }
//如果判断通过上传文件到OSS
...
//解析上传成功的结果
                ...
                return "http://s9950d7r2.hd-bkt.clouddn.com/"+key;
